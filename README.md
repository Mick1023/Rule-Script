...
[![Stable Version](https://img.shields.io/badge/stable-v1.6.0-blue)](https://github.com/Mick1023/Rule-Script/releases/tag/v1.6.0)
...
```bash
dotnet add package RuleScript.Core --version 1.6.0
```
...
The latest stable source is available on [`main`](https://github.com/Mick1023/Rule-Script/tree/main). See the [v1.6.0 release notes](docs/releases/v1.6.0.md) for source formatting, comments, regions, documentation metadata, and Host Function metadata updates.
