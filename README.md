...
[![Prerelease Version](https://img.shields.io/badge/prerelease-v1.9.0--rc1.1-orange)](https://github.com/Mick1023/Rule-Script/releases/tag/v1.9.0-rc1.1)
...
```bash
dotnet add package RuleScript.Core --version 1.9.0-rc1.1
```
