...
[![Stable Version](https://img.shields.io/badge/stable-v1.8.0-blue)](https://github.com/Mick1023/Rule-Script/releases/tag/v1.8.0)
...
```bash
dotnet add package RuleScript.Core --version 1.8.0
```
